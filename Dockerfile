...
RUN mkdir -p /root/.cache && \
    wget https://github.com/microsoft/playwright-java/releases/download/v1.48.0/playwright-java-1.48.0.zip && \
    unzip playwright-java-1.48.0.zip -d /root/.cache && \
    rm playwright-java-1.48.0.zip && \
    /root/.cache/playwright-java-1.48.0/playwright install --with-deps
